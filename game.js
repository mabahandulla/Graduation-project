...
class Actor {
  ...
  isIntersect(actor) {
    ...
    return (this === actor || (actor.size.x < 0 && actor.size.y < 0) ||
    (this.pos.valueOf() < actor.pos.valueOf() && this.size.valueOf() < actor.size.valueOf()) ||
    (this.pos.x === actor.pos.x || this.pos.y === actor.pos.y)
    ) ? false : true;
